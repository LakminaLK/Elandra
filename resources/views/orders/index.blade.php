                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="font-medium text-blue-900">
                                        {{ $order->orderItems->count() }} item(s) • {{ $order->orderItems->sum('quantity') }} total quantity
                                    </span>
                                </div>
                                <div class="text-blue-800 font-semibold">
                                    Items Total: ${{ number_format($order->orderItems->sum('total_price'), 2) }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                                ...
                                @if($mongoProduct && isset($mongoProduct->images[0]))
                                    <img src="{{ asset('storage/' . $mongoProduct->images[0]) }}" alt="{{ $item->product_name }}" class="w-16 h-16 object-cover rounded-lg">
                                @else
                            ...
                            <div class="text-sm text-gray-600 text-center py-2 bg-gray-100 rounded-lg">
                                ...
                                <a href="{{ route('orders.show', $order) }}" class="text-blue-600 hover:text-blue-800 font-medium">View All</a>
                            </div>
                            @endif
                        </div>
                    @else
