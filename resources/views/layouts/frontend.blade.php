...
<head>
    ...
    <title>{{ config('app.name', 'Elandra') }} - @yield('title', 'Luxury Handbags')</title>
    ...
    <meta name="msapplication-TileImage" content="{{ asset('elandra-logo.webp') }}">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="flex items-center">
                        <a href="{{ route('home') }}" class="flex items-center space-x-3 group">
                            <div class="relative">
                                ...
                                <img src="{{ asset('elandra-logo.webp') }}" alt="Elandra Logo" class="w-12 h-12 object-contain rounded-full relative border-2 border-white shadow-lg" onerror="this.style.display='none'">
                            </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        @auth
                            <!-- Cart Button -->
                            <a href="{{ route('cart') }}" class="relative inline-flex items-center px-3 py-2 text-gray-700 hover:text-primary hover:bg-gray-50 transition-all duration-300 group">
                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open" class="flex items-center px-3 py-2 text-gray-700 hover:text-primary hover:bg-gray-50 transition-all duration-300 group">
                                    ...
                                    <div x-show="open" @click.away="open = false" x-cloak 
                                        ...
                                        <!-- Menu Items -->
                                        <div class="py-1">
                                            <a href="{{ route('profile.show') }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-primary/5 hover:to-accent/5 hover:text-primary group transition-all duration-200">
                                                <i class="fas fa-user-circle w-5 text-gray-400 group-hover:text-primary transition-colors mr-3"></i>
                                                <span>Profile</span>
                                            </a>
                                            
                                            <a href="{{ route('orders.index') }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-primary/5 hover:to-accent/5 hover:text-primary group transition-all duration-200">
                        ...
                        <div class="md:hidden flex items-center space-x-3">
                            @auth
                                <!-- Mobile Cart -->
                                <a href="{{ route('cart') }}" class="relative p-2 text-gray-700 hover:text-primary transition-colors duration-300">
                                    ...
                                    <div class="px-4">
                                        <div class="flex items-center justify-between mb-6 border-b border-gray-100 pb-6">
                                            <a href="{{ route('home') }}" class="flex items-center space-x-3">
                                                <img src="{{ asset('elandra-logo.webp') }}" alt="Elandra Logo" class="w-10 h-10 object-contain rounded-full border-2 border-gray-100 shadow-sm">
                                        ...
                                        <div class="space-y-1 py-4">
                                            <a href="{{ route('home') }}" class="block py-3 px-4 text-base font-medium rounded-lg mx-2 {{ request()->routeIs('home') ? 'text-primary bg-gradient-to-r from-primary/10 to-accent/10' : 'text-gray-700 hover:bg-gray-50' }} transition-all duration-200">
                                                <i class="fas fa-home w-5 mr-3"></i>Home
                                            </a>
                                            <a href="{{ route('products.index') }}" class="block py-3 px-4 text-base font-medium rounded-lg mx-2 {{ request()->routeIs('products.index') ? 'text-primary bg-gradient-to-r from-primary/10 to-accent/10' : 'text-gray-700 hover:bg-gray-50' }} transition-all duration-200">
                                        ...
                                        <div class="mt-6 pt-6 border-t border-gray-100">
                                            @auth
                                                ...
                                                <!-- Mobile Menu Items -->
                                                <div class="space-y-1">
                                                    <a href="{{ route('cart') }}" class="flex items-center justify-between py-3 px-4 text-base font-medium text-gray-700 hover:bg-gray-50 rounded-lg transition-colors duration-200 group">
                                                        <div class="flex items-center">
                                                            <i class="fas fa-shopping-cart w-5 text-primary mr-3"></i>
                                                            <span>Shopping Cart</span>
                                                        </div>
                                                        <!-- Visible mobile cart count -->
                                                        @livewire('cart-count', ['mobile' => true])
                                                    </a>
                                                    
                                                    <a href="{{ route('profile.show') }}" class="flex items-center py-3 px-4 text-base font-medium text-gray-700 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                                                        <i class="fas fa-user-circle w-5 text-primary mr-3"></i>
                                                        <span>Profile</span>
                                                    </a>
                                                    
                                                    <a href="{{ route('orders.index') }}" class="flex items-center py-3 px-4 text-base font-medium text-gray-700 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                                            ...
                                            @else
                                                ...
                                                <div class="px-4 space-y-3">
                                                    <a href="{{ route('login') }}" class="flex items-center justify-center py-4 px-6 border-2 border-gray-300 rounded-xl text-gray-700 font-semibold hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:translate-y-[-1px] hover:scale-105 group">
                                                        <i class="fas fa-sign-in-alt mr-3 group-hover:scale-110 transition-transform duration-300 text-base"></i>
                                                        <span class="font-semibold">Login to Account</span>
                                                    </a>
                                                    
                                                    <a href="{{ route('register') }}" class="flex items-center justify-center py-4 px-6 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 hover:from-blue-700 hover:via-purple-700 hover:to-blue-800 text-white font-semibold rounded-xl shadow-xl hover:shadow-2xl transform hover:translate-y-[-1px] hover:scale-105 transition-all duration-300 group">
                                                        <i class="fas fa-user-plus mr-3 group-hover:scale-110 transition-transform duration-300 text-base"></i>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div class="lg:col-span-2">
                        <div class="flex items-center space-x-4 mb-8">
                            <div class="relative">
                                <img src="{{ asset('elandra-logo.webp') }}" alt="Elandra Logo" class="w-16 h-16 object-contain rounded-full ring-4 ring-amber-500/20" onerror="this.style.display='none'">
                    ...
                    <div>
                        ...
                        <ul class="space-y-4">
                            <li><a href="{{ route('home') }}" class="text-gray-200 hover:text-amber-400 transition-all duration-300 flex items-center group text-base hover:translate-x-2">
                                <i class="fas fa-chevron-right text-xs mr-3 text-amber-400 group-hover:mr-4 transition-all duration-300"></i>Home</a></li>
                            <li><a href="{{ route('products.index') }}" class="text-gray-200 hover:text-amber-400 transition-all duration-300 flex items-center group text-base hover:translate-x-2">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
                    <div class="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
                        ...
                        <div class="text-gray-200 text-base font-medium flex items-center">
                            ...
                            {{ date('Y') }} Elandra. All rights reserved. | <span class="text-amber-400 ml-2">Luxury redefined for the modern world.</span>
                        </div>
