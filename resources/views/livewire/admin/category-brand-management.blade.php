                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            <button wire:click="openEditCategoryModal('{{ $category->_id }}')" 
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($brands as $brand)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div>
                                            ...
                                            @if($brand->description)
                                                <div class="text-sm text-gray-500 mt-1">{{ Str::limit($brand->description, 60) }}</div>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            <button wire:click="openEditBrandModal('{{ $brand->_id }}')" 
                                                    class="text-blue-600 hover:text-blue-900 transition-colors">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button wire:click="deleteBrand('{{ $brand->_id }}')" 
                        ...
                        <div class="bg-white px-6 py-4">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    @error('brandName') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    @error('brandDescription') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                </div>
