        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <div class="p-6 flex items-center space-x-4 transition-all duration-300 {{ in_array($item->id, $selectedItems) ? 'bg-blue-50 border-l-4 border-blue-500' : 'hover:bg-gray-50' }}">
                        <!-- Checkbox -->
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <button 
                                wire:click="updateQuantity({{ $item->id }}, {{ $item->quantity + 1 }})"
                                @if($product && $item->quantity >= $product->stock_quantity) disabled @endif
                                class="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                <svg class="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6 space-y-4">
                    @if(count($selectedItems) > 0)
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <span class="text-blue-700">{{ count($selectedItems) }} item(s)</span>
                            </div>
                    ...
                    @else
                        ...
                        <div class="text-center py-4 text-gray-500">
                            <div class="mb-2">
                                <span class="text-sm">Total in Cart: {{ $cartItems->sum('quantity') }} items</span>
                            </div>
