...
<div class="relative overflow-hidden min-h-screen flex items-center bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
    ...
    <div class="absolute inset-0">
        <img src="{{ asset('images/hero-elegant-handbag.jpg') }}" alt="Luxury Fashion Background" class="w-full h-full object-cover opacity-12">
                ...
                <div class="relative">
                    ...
                    <div class="relative bg-white rounded-2xl p-8 shadow-2xl border border-gray-100 group hover:shadow-3xl transition-all duration-700">
                        ...
                        <div class="rounded-xl h-80 overflow-hidden group-hover:scale-105 transition-transform duration-500">
                            <img src="{{ asset('images/hero-luxury-handbag.jpg') }}" 
                                 alt="Elandra Luxury Handbags Collection" 
                                 class="w-full h-full object-cover"
                                 onerror="this.onerror=null; this.src='{{ asset('images/hero-premium-bag.jpg') }}';">
                        </div>
...
<section class="py-20 bg-gradient-to-b from-slate-50 to-white" id="featured">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="product-card group bg-white rounded-xl shadow-sm hover:shadow-lg border border-gray-200 overflow-hidden transition-shadow duration-300 flex flex-col h-full" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="100">
                <div class="flex items-center mb-6">
                    <img src="{{ asset('images/users/sarah-johnson.jpg') }}" alt="Sarah Johnson - Fashion Blogger" class="w-12 h-12 rounded-full object-cover mr-4 ring-2 ring-blue-100">
                    <div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="200">
                <div class="flex items-center mb-6">
                    <img src="{{ asset('images/users/emma-williams.jpg') }}" alt="Emma Williams - Executive" class="w-12 h-12 rounded-full object-cover mr-4 ring-2 ring-blue-100">
                    <div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-100 group hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-up" data-aos-delay="300">
                <div class="flex items-center mb-6">
                    <img src="{{ asset('images/users/lisa-chen.jpg') }}" alt="Lisa Chen - Designer" class="w-12 h-12 rounded-full object-cover mr-4 ring-2 ring-blue-100">
                    <div>
...
<section class="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden relative">
    <div class="absolute inset-0 opacity-20">
        <img src="{{ asset('images/fashion-stairs.jpg') }}" alt="Luxury Fashion" class="w-full h-full object-cover">
    </div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div data-aos="fade-right">
                ...
                <a href="{{ route('products.index') }}" class="inline-flex items-center bg-yellow-400 text-gray-900 px-8 py-4 rounded-xl font-semibold hover:bg-yellow-300 transition-all transform hover:scale-105 shadow-lg">
            ...
            <div class="relative" data-aos="fade-left">
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-4">
                        <img src="{{ asset('images/story/luxury-craftsmanship.jpg') }}" alt="Luxury Craftsmanship" class="w-full h-48 object-cover rounded-2xl shadow-2xl transform rotate-2 hover:rotate-0 transition-transform duration-500 hover:scale-105">
                        <img src="{{ asset('images/story/fashion-excellence.jpg') }}" alt="Fashion Excellence" class="w-full h-32 object-cover rounded-2xl shadow-2xl transform -rotate-2 hover:rotate-0 transition-transform duration-500 hover:scale-105">
                    </div>
                    <div class="space-y-4 mt-8">
                        <img src="{{ asset('images/story/elegant-style.jpg') }}" alt="Elegant Style" class="w-full h-32 object-cover rounded-2xl shadow-2xl transform rotate-1 hover:rotate-0 transition-transform duration-500 hover:scale-105">
                        <img src="{{ asset('images/story/premium-quality.jpg') }}" alt="Premium Quality" class="w-full h-48 object-cover rounded-2xl shadow-2xl transform -rotate-1 hover:rotate-0 transition-transform duration-500 hover:scale-105">
                    </div>
                </div>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-green-100">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative">
                    <img src="{{ asset('images/story/luxury-craftsmanship.jpg') }}" alt="Quality Guarantee" class="w-full rounded-2xl shadow-2xl hover:scale-105 transition-transform duration-300">
