    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <div id="orders-container" class="space-y-6">
            ...
            <div class="order-card bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-200" 
                 ...
                 data-order-number="<?php echo e(strtolower($order->order_number)); ?>"
                 data-status="<?php echo e($order->status); ?>"
                 data-date="<?php echo e($order->created_at->format('Y-m-d')); ?>"
                 data-amount="<?php echo e($order->total_amount); ?>">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600"><?php echo e($order->created_at->format('M d, Y')); ?> • <?php echo e($order->created_at->diffForHumans()); ?></p>
                            </div>
                        </div>
                        <div class="text-right">
                            <div class="text-xl font-semibold text-gray-900">$<?php echo e(number_format($order->total_amount, 2)); ?></div>
                            ...
                            <div class="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                                ...
                                <?php if($mongoProduct && isset($mongoProduct->images[0])): ?>
                                    <div class="flex-shrink-0">
                                        <img src="<?php echo e(asset('storage/' . $mongoProduct->images[0])); ?>" 
                                ...
                                <div class="flex-1 min-w-0">
                                    <h4 class="font-medium text-gray-900 truncate"><?php echo e($item->product_name); ?></h4>
                                    <div class="flex items-center space-x-4 text-sm text-gray-600 mt-1">
                                        <span>Qty: <?php echo e($item->quantity); ?></span>
                                        <span>Unit: $<?php echo e(number_format($item->unit_price, 2)); ?></span>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button onclick="reorderItems('<?php echo e($order->id); ?>')"
