                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                type="text"
                                id="current_name"
                                value="<?php echo e(auth('admin')->user()->name ?? 'Administrator'); ?>"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                type="email"
                                id="current_email"
                                value="<?php echo e(auth('admin')->user()->email ?? 'admin@elandra.com'); ?>"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-500 cursor-not-allowed outline-none focus:outline-none"
                                readonly
                            >
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Elandra\resources\views/admin/profile/index.blade.php ENDPATH**/ ?>