...
<head>
    ...
    <title>Login - <?php echo e(config('app.name', 'Elandra')); ?></title>
...
<body class="h-screen flex overflow-hidden">
    ...
    <div class="hidden lg:block lg:w-3/5 relative overflow-hidden animate-slide-left">
        ...
        <img 
            src="<?php echo e(asset('images/login-images.webp')); ?>" 
        ...
        <div class="absolute inset-0 flex flex-col justify-between p-8">
            ...
            <div class="flex items-center space-x-3 animate-fade-up animate-delay-200">
                <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-lg">
                    <img 
                        src="<?php echo e(asset('elandra-logo.webp')); ?>" 
                        alt="Elandra Logo" 
            ...
            <div class="login-card rounded-2xl p-8 animate-fade-up animate-delay-200">
                ...
                <form x-data="loginForm()" class="space-y-6">
                    <?php if(request('redirect')): ?>
                        <input type="hidden" name="redirect" value="<?php echo e(request('redirect')); ?>" x-ref="redirect">
                    <?php endif; ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input 
                            ...
                            name="email"
                            x-model="email" 
                            value="<?php echo e(session('registered_email') ?? old('email')); ?>"
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-indigo-600 hover:text-indigo-800 transition-colors">
                                Forgot password?
                            </a>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="text-center mb-4">
                        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-gray-500 hover:text-indigo-600 transition-colors font-medium">
                    ...
                    <div class="text-center">
                        <p class="text-gray-600 text-sm">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="text-indigo-600 hover:text-indigo-800 transition-colors font-medium">
                                Create Account
                            </a>
                        </p>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center text-sm text-gray-500 hover:text-indigo-600 transition-colors">
    ...
    >
                    ...
                    <div class="flex-1">
                        ...
                        <?php if(session('registered_email')): ?>
                            <div class="text-green-100 text-sm pl-6 mt-1">
                                Please use <strong><?php echo e(session('registered_email')); ?></strong> to login below.
                            </div>
                        <?php endif; ?>
                    </div>
        ...
        <?php elseif($errors->any()): ?>
            ...
            ?>
            <div class="<?php echo e($bgColor); ?> text-white px-6 py-4 rounded-xl shadow-lg flex items-start justify-between gap-4 min-w-80">
                <div class="flex items-start gap-3">
                    <i class="<?php echo e($icon); ?> text-lg mt-1"></i>
                    <div>
                ...
                <button @click="show = false" class="text-white <?php echo e($hoverColor); ?> rounded-lg px-2 py-1 transition-colors">
                    <i class="fas fa-times"></i>
                </button>
            </div>
        <?php endif; ?>
    ...
    <script>
        function loginForm() {
            return {
                email: '<?php echo e(session("registered_email") ?? old("email")); ?>',
                password: '',
...
<?php /**PATH C:\xampp\htdocs\Elandra\resources\views/auth/login.blade.php ENDPATH**/ ?>