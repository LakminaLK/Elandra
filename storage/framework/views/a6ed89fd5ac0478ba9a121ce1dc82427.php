...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="px-6 py-8">
                <div class="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6">
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        ...
                        <?php if($user->phone): ?>
                            <p class="text-gray-600 mt-1">📱 <?php echo e($user->phone); ?></p>
                        <?php endif; ?>
        ...
        <?php if(session('password_success')): ?>
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-6" role="alert">
                <span class="block sm:inline"><?php echo e(session('password_success')); ?></span>
            </div>
        <?php endif; ?>

        <?php if(session('mobile_success')): ?>
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-6" role="alert">
                <span class="block sm:inline"><?php echo e(session('mobile_success')); ?></span>
            </div>
        <?php endif; ?>

        <?php if(session('photo_success')): ?>
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-6" role="alert">
                <span class="block sm:inline"><?php echo e(session('photo_success')); ?></span>
            </div>
        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="address" name="address" rows="3" 
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('address', $user->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="country" name="country" value="<?php echo e(old('country', $user->country)); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    ...
                    <form action="<?php echo e(route('profile.password.update')); ?>" method="POST" class="p-6">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    ...
                    <form action="<?php echo e(route('profile.mobile.update')); ?>" method="POST" class="p-6">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>

                        <div>
                            <label for="phone_update" class="block text-sm font-medium text-gray-700 mb-1">Mobile Number</label>
                            <input type="text" id="phone_update" name="phone" value="<?php echo e(old('phone', $user->phone)); ?>" 
                                   placeholder="Enter your mobile number"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
                            <?php $__errorArgs = ['phone', 'mobile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<div id="photoModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <!-- Upload Photo Form -->
            <form action="<?php echo e(route('profile.photo.upload')); ?>" method="POST" enctype="multipart/form-data" class="mb-4">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
                    ...
                    <?php $__errorArgs = ['profile_photo', 'photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if($user->profile_photo_path): ?>
                <!-- Remove Photo Form -->
                <form action="<?php echo e(route('profile.photo.remove')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Elandra\resources\views/profile/show.blade.php ENDPATH**/ ?>